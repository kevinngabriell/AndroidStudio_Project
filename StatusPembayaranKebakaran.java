...
public class StatusPembayaranKebakaran extends AppCompatActivity {
    ...
    String url_get_data = "https://kelompok4mobapp.000webhostapp.com//StatusPembayaranKebakaran.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_status_pembayaran_kebakaran);

        progressDialog = new ProgressDialog(StatusPembayaranKebakaran.this);
        btnFetch = (Button) findViewById(R.id.buttonfetch4);
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String SPAKB = txtvalue.getText().toString();
                if(!SPAKB.equals("")){
                    getDataByIDAKB(SPAKB);
                }
                else {
    ...
    public void getDataByIDAKB(final String SPAKB) {
        if (checkNetworkConnection()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url_get_data,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                for (int i = 0; i < result.length(); i++) {
                                    ...
                                    list_dataK.add(map);
                                    String[] from = {"IDAsuransiKebakaran", "NamaLengkapAK", "StatusPembayaran"};
                                    int[] to = {R.id.test, R.id.test2, R.id.test3};

                                    ListAdapter adapter = new SimpleAdapter(
                                            StatusPembayaranKebakaran.this, list_dataK, R.layout.test,
                                            from, to);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("IDAsuransiKebakaran", SPAKB);
                    return params;
                }
            };

            VolleyConnection.getInstance(StatusPembayaranKebakaran.this).addToRequestQue(stringRequest);
