...
public class tampilanRegister extends AppCompatActivity {
    ...
    EditText email, passsword, confPassword;
    Button register;
    TextView TextLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passsword = (EditText) findViewById(R.id.txtPasswordLogin);
        confPassword = (EditText) findViewById(R.id.txtConfirmPass);
        register = (Button) findViewById(R.id.btnLogin);
        TextLogin = (TextView) findViewById(R.id.TextLogin);
        progressDialog = new ProgressDialog(tampilanRegister.this);

        TextLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent TextLogin = new Intent(tampilanRegister.this, tampilanLogin.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sPassword.equals(sConfPassword) && !sPassword.equals("")) {
                    CreateDataToServer(sPassword, sEmail, sConfPassword);
                    Intent loginIntent = new Intent(tampilanRegister.this, tampilanLogin.class);
    ...
    public void CreateDataToServer(final String username, final String email, final String password) {
        if (checkNetworkConnection()) {
            ...
            VolleyConnection.getInstance(tampilanRegister.this).addToRequestQue(stringRequest);
