...
public class StatusClaimKendaraan extends AppCompatActivity {
    ...
    String url_get_data = "https://kelompok4mobapp.000webhostapp.com//StatusClaimKendaraan.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_status_claim_kendaraan);

        progressDialog = new ProgressDialog(StatusClaimKendaraan.this);
        btnFetch = (Button) findViewById(R.id.buttonfetch8);
        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String SCKND = txtvalue.getText().toString();
                if(!SCKND.equals("")){
                    getDataBySCKND(SCKND);
                }
                else {
    ...
    public void getDataBySCKND(final String SCKND) {
        if (checkNetworkConnection()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url_get_data,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                for (int i = 0; i < result.length(); i++) {
                                    ...
                                    list_dataK.add(map);
                                    String[] from = {"IDAsuransiKendaraan", "NamaLengkapKND", "StatusClaim"};
                                    int[] to = {R.id.test, R.id.test2, R.id.test3};

                                    ListAdapter adapter = new SimpleAdapter(
                                            StatusClaimKendaraan.this, list_dataK, R.layout.test,
                                            from, to);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("IDAsuransiKendaraan", SCKND);
                    return params;
                }
            };

            VolleyConnection.getInstance(StatusClaimKendaraan.this).addToRequestQue(stringRequest);
